...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        passwordLayout.setEndIconTintList(ColorStateList.valueOf(orange))
        ...
        form.addView(passwordLayout, LinearLayout.LayoutParams(-1, -2).apply { setMargins(0, 16, 0, 48) })
        ...
        loginButton.setOnClickListener {
            ...
            lifecycleScope.launch {
                try {
                    val auth = withContext(Dispatchers.IO) { ApiService.login(email, password) }
